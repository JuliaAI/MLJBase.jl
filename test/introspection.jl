...
MLJBase.target_kind(::Type{Dummy}) = :continuous
MLJBase.target_quantity(::Type{Dummy}) = :univariate
MLJBase.inputs_can_be(::Type{Dummy}) = [:continuous, ]
MLJBase.inputs_quantity(::Type{Dummy}) = :univariate
...
d = Dict(:name => "Dummy",
         ...
         :target_is     => Symbol[:deterministic, :continuous, :univariate],
         :inputs_can_be => Symbol[:continuous],
         :inputs_quantity => :univariate,
